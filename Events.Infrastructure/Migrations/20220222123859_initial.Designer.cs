...
namespace Events.Infrastructure.Migrations
{
    ...
    [Migration("20220222123859_initial")]
                    ...
                    b.OwnsOne("Events.Core.Shared.ValueObjects.Location", "Location", b1 =>
                        {
                            ...
                            b1.OwnsOne("System.Device.Location.GeoCoordinate", "GeoCoordinate", b2 =>
                                {
                                    b2.Property<Guid>("LocationEventId")
                                        .HasColumnType("uniqueidentifier");

                                    b2.Property<double>("Altitude")
                                        .HasColumnType("float");

                                    b2.Property<double>("Course")
                                        .HasColumnType("float");

                                    b2.Property<double>("HorizontalAccuracy")
                                        .HasColumnType("float");
                                    ...
                                    b2.Property<double>("VerticalAccuracy")
                                        .HasColumnType("float");
                    ...
                    b.OwnsOne("Events.Core.Shared.ValueObjects.Location", "Location", b1 =>
                        {
                            ...
                            b1.OwnsOne("System.Device.Location.GeoCoordinate", "GeoCoordinate", b2 =>
                                {
                                    b2.Property<Guid>("LocationOfficeId")
                                        .HasColumnType("uniqueidentifier");
